const Hero = () => {
  return (
    <section className="relative bg-gray-950 text-white min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-emerald-900/10 to-gray-950 z-0"></div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-emerald-300 mb-2 font-mono animate-pulse">
        ...
        <h1 className="text-6xl md:text-7xl font-extrabold mb-6">
          ...
          <br />
          <span className="text-emerald-600 drop-shadow-[0_0_15px_rgba(16,185,129,0.5)]">
            al siguiente nivel
          </span>
        </h1>
        ...
        <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-10 opacity-90 animate-fade-in">
          Soluciones <span className="font-semibold text-emerald-300">personalizadas</span> para escalar tu marca en el mercado global.
        </p>

        {/* Botón con hover sofisticado */}
        <button className="bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-emerald-700 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-emerald-600/30">
