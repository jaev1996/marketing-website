  ...
  return (
    <section id="services" className="py-20 bg-white text-gray-950">
      <div className="container mx-auto px-4">
        ...
        {/* Segunda fila: Servicios sin imágenes */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.slice(2).map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-purple-300 h-full p-6"
              >
                <div className="flex items-center justify-center w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-purple-500 to-purple-700 text-white group-hover:rotate-6 transition-transform mx-auto">
                  <IconComponent className="w-6 h-6" />
                </div>
